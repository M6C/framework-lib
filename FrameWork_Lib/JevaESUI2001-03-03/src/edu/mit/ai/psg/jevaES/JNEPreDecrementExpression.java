...
// Source File Name:   jevaES/JNEPreDecrementExpression.java
...
public class JNEPreDecrementExpression extends ExpressionNode
{

    JNEPreDecrementExpression(int id)
    {
        super(id);
    }
        ...
        throws ThrowException
    {
        ...
        Object newValue = PrimitiveOperations.castPrimitive(targetType, PrimitiveOperations.subtract(previousValue, one));
