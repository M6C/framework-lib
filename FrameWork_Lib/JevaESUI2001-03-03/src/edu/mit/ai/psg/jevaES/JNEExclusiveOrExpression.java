...
// Source File Name:   jevaES/JNEExclusiveOrExpression.java
...
public class JNEExclusiveOrExpression extends LeftAssociativeOperatorExpression
{

    JNEExclusiveOrExpression(int id)
    {
        super(id);
    }
    ...
    {
        return PrimitiveOperations.xor(accumResult, nextResult);
    }
}
